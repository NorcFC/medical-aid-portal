...
<title>MedAid · Provider Login</title>
...
<main class="container">
  <div class="glass-card p-4 p-md-5">
    ...
    <form action="dashboard.jsp" method="post">
      <div class="mb-3"><label class="form-label">Provider Code</label><input class="form-control" name="providerCode" required></div>
      <div class="mb-3"><label class="form-label">Password</label><input class="form-control" type="password" name="password" required></div>
      <button class="btn btn-info text-white w-100">Continue</button>
    </form>
